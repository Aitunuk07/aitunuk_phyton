...
class CalculatorSelector:
    def __init__(self):
        ...
        # Кнопка для стандартного калькулятора
        ...
        # Кнопка для научного калькулятора
    ...
    def open_standard(self):
        ...
        StandardCalculator()  # Запускаем стандартный калькулятор
    
    def open_scientific(self):
        self.root.destroy()  # Закрываем окно выбора
        ScientificCalculator()  # Запускаем научный калькулятор
    #--------------------------------    
